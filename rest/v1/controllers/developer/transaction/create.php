...
$transaction->transaction_cart_books = json_encode($data["transaction_cart_books"]);
$transaction->transaction_cart_bestsellers = json_encode($data["transaction_cart_bestsellers"]);
