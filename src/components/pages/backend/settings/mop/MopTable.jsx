...
const MopTable = () => {
  ...
  const {
    ...
    queryKey: ["mop", onSearch, store.isSearch],
    queryFn: async ({ pageParam = 1 }) =>
      await queryDataInfinite(
        `/v1/mop/search`, // search endpoint
        `/v1/mop/page/${pageParam}`, // list endpoint
